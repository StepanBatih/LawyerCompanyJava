...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Lawyer stepan = new Advocate(0, 0.0, "Stepan", Lawsuit.MAKINGCLAIM, 10);
        Lawyer vlad = new Advocate(2, 10.0, "Vlad", Lawsuit.EVIDECECOLLECTION, 12);
        Lawyer taras = new Advocate(3, 10.0, "Taras", Lawsuit.CONTRUCTCONSULTION, 11);
        Lawyer mykola = new Advocate(2, 10.0, "Danz", Lawsuit.CONTRUCTCONSULTION, 23);
        Lawyer nord = new Advocate(10, 10.0, "Daniel", Lawsuit.CONTRUCTCONSULTION, 12);
